...
$id = $_GET["id"];
$sql = $conexion->query("select * from stockcmd where ID=$id");
...
<head>
    ...
    <title>Modificar Stock CMD</title>
    <!-- slider stylesheet -->
...
<body>
    ...
    <form class="col-4 p-3 m-auto" method="POST">
      <h5 class="text-center alert alert-secondary">Modificar Stock CMD</h5>
      ...
      while ($datos = $sql->fetch_object()) { ?>
            ...
            <a href="stockCmd.php" class="btn btn-warning mb-1">VOLVER</a>
