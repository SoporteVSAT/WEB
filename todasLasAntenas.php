...
<body>
        ...
        <form class="table-primary" id="miFormulario" method="post">
          ...
          <div>
            ...
            <select class="form-select" aria-label="Default select example" id="estado" name="estado">
              ...
              <option value="Activo" id="estado" name="estado">Activo</option>
              <option value="Baja" id="estado" name="estado">Baja</option>
              <option value="En Base" id="estado" name="estado">En Base</option>
            </select>
          ...
          <div>
            ...
            <select class="form-select" aria-label="Default select example" id="proveedor" name="proveedor">
              <option value="0">Seleccione</option>
              <option value="Arsat" id="proveedor" name="proveedor">Arsat</option>
              <option value="Orbith" id="proveedor" name="proveedor">Orbith</option>
              <option value="Telespazio" id="proveedor" name="proveedor">Telespazio</option>
              <option value="Telefonica" id="proveedor" name="proveedor">Telefonica</option>
            </select>
          ...
          <div>
            ...
            <select class="form-select" aria-label="Default select example" id="modem" name="modem">
              <option value="0">Seleccione</option>
              <option value="iDirect MDM" id="modem" name="modem">iDirect MDM</option>
              <option value="iDirect X1" id="modem" name="modem">iDirect X1</option>
              <option value="Gemini II" id="modem" name="modem">Gemini II</option>
            </select>
          ...
          <div>
            ...
            <select class="form-select" aria-label="Default select example" id="plan" name="plan">
              <option value="0">Seleccione</option>
              <option value="Business 100" id="plan" name="plan">Orbith Business 100</option>
              <option value="Business 150" id="plan" name="plan">Orbith Business 150</option>
              <option value="Business 200" id="plan" name="plan">Orbith Business 200</option>
              <option value="Telefonica 120" id="plan" name="plan">Telefonica 120</option>
              <option value="Telefonica 80" id="plan" name="plan">Telefonica 80</option>
              <option value="Telefonica 60" id="plan" name="plan">Telefonica 60</option>
              <option value="Telefonica 40" id="plan" name="plan">Telefonica 40</option>
              <option value="Telespazio 50" id="plan" name="plan">Telespazio 50</option>
              <option value="Telespazio 100" id="plan" name="plan">Telespazio 100</option>
              <option value="Arsat 50" id="plan" name="plan">Arsat 50</option>
              <option value="Arsat 100" id="plan" name="plan">Arsat 100</option>
            </select>
            <!--            
          ...
          <div>
            ...
            <select class="form-select" aria-label="Default select example" id="beam" name="beam">
              <option value="0">Seleccione</option>
              <option value="Beam 7" id="beam" name="beam">Beam 7</option>
              <option value="Beam 10" id="beam" name="beam">Beam 10</option>
              <option value="Beam 9" id="beam" name="beam">Beam 9</option>
              <option value="Beam 6" id="beam" name="beam">Beam 6</option>
            </select>
          ...
          <div>
            ...
            <select class="form-select" aria-label="Default select example" id="router" name="router">
              <option value="0">Seleccione</option>
              <option value="Mikrotik RB 941" id="router" name="router">Mikrotik RB 941</option>
              <option value="Mikrotik" id="router" name="router">Mikrotik </option>
              <option value="Tp Link" id="router" name="router">Tp Link</option>
            </select>
  ...
  <table class="table table-striped-columns" id="tabladatos">
    ...
    <tbody>
      ...
      include "conexion.php";
      $sql = $conexion->query(" select * from todaslasantenas ");
