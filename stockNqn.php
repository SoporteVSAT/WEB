...
<body>
  ...
  <div class="hero_area">
    ...
    <div class="table-secondary">
      <h1 class="text-center" id="titulostocknqn">Stock de Neuquen</h1>
    </div>
    <div>
        ...
        <table class="table table-secondary table-striped-columns ">
          ...
          <tbody>
            <?php
            include "conexion.php";
            $sql = $conexion->query(" SELECT * from stocknqn ");
            ...
            ?>
              ...
              <tr>
                ...
                <td>
                <a href="modificarstocknqn.php?id=<?= $datos->ID?>" class="btn btn-small btn-warning"><img src="images/pencil-fill.svg" alt="" ></a>
                <a onclick="return eliminar()" href="stocknqn.php?id=<?= $datos->ID ?>" class="btn btn-small btn-danger"><img src="images/archive-fill.svg" alt=""></a>
        ...
        if (isset($_POST['btnregistrar'])) {
          ...
          $insertarDatos = "INSERT INTO stocknqn VALUES('','$Producto', '$Cantidad')";
