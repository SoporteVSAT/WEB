...
<body>
  <script>
    ...
    <div class="table-secondary">
      <h1 class="text-center" id="titulostocknqn">Stock de Antenas</h1>
    </div>
    ...
    <div>
        ...
        <?php
            ...
            include "editarstockantenas.php";
            include "eliminarstockantenas.php";
        ...
        <table class="table table-secondary table-striped-columns ">
          ...
          <tbody>
            <?php
            include "conexion.php";
            $sql = $conexion->query(" select * from stockantenas ");
            ...
            ?>
              ...
              <tr>
                ...
                <td>
                  <a href="modificarstockantenas.php?id=<?= $datos->ID?>" class="btn btn-small btn-warning"><img src="images/pencil-fill.svg" alt="" ></a>
                  <a onclick="return eliminar()" href="stockantenas.php?id=<?= $datos->ID ?>" class="btn btn-small btn-danger"><img src="images/archive-fill.svg" alt=""></a>
        ...
        if (isset($_POST['btnregistrar'])) {
          ...
          $insertarDatos = "insert into stockantenas values('','$Producto', '$Cantidad')";
