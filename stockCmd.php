...
<body>
  ...
  <div class="hero_area">
    ...
    <div class="table-secondary">
      <h1 class="text-center" id="titulostocknqn">Stock de Comodoro</h1>
    </div>
    <div>
        <form method="POST" id="miFormulario">
        <?php
            include "conexion.php";
            include "editarstockcmd.php";
            include "eliminarstockcmd.php";
        ...
        <table class="table table-secondary table-striped-columns ">
          ...
          <tbody>
            <?php
            include "conexion.php";
            $sql = $conexion->query(" SELECT * from stockcmd ");
            ...
            ?>
              ...
              <tr>
                ...
                <td>
                <a href="modificarstockcmd.php?id=<?= $datos->ID?>" class="btn btn-small btn-warning"><img src="images/pencil-fill.svg" alt="" ></a>
                <a onclick="return eliminar()" href="stockcmd.php?id=<?= $datos->ID ?>" class="btn btn-small btn-danger"><img src="images/archive-fill.svg" alt=""></a>
        ...
        if (isset($_POST['btnregistrar'])) {
          ...
          $insertarDatos = "INSERT INTO stockcmd VALUES('','$Producto', '$Cantidad')";
