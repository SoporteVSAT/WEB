...
<head>
  ...
  <title>Todas las Antenas ARSAT</title>
  <!-- slider stylesheet -->
...
<body>
  ...
  <h1 class="text-center">LISTADO DE ANTENAS ARSAT</h1>
  ...
  <table class="table table-striped-columns" id="tabladatos">
    ...
    <tbody>
      ...
      include "conexion.php";
      $sql = $conexion->query(" select * from todaslasantenas where Proveedor='Arsat' ");
