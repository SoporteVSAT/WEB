...
<head>
  ...
  <title>Todas las Antenas TELESPAZIO</title>
  <!-- slider stylesheet -->
...
<body>
  ...
  <h1 class="text-center">LISTADO DE ANTENAS TELESPAZIO</h1>
  ...
  <table class="table table-striped-columns" id="tabladatos">
    ...
    <tbody>
      ...
      include "conexion.php";
      $sql = $conexion->query(" select * from todaslasantenas where Proveedor='Telespazio' ");
